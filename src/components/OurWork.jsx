        ...
        <div className="persons">
          <div className="person person-1">
            <div className="left-side">
              <motion.img src="https://ice-eu-108964.icedrive.io/download?p=HsE.Avkgho139bzq5c6mYOu3jX21mTSgptDX2GVoQc1ab.xyl2CdpRNk_gbY2PWwGUx7sKuXuBvnN0o3.i0uLUrjRLoJG.Iccg8Bw1mvE0pBGp00RjzZCopg9IdEur3tKnTCbZ09QdnYn2e7iWaZ0Q1pEHBZrREzdqY1Wzxapbzm9pfTzXqRRKmtc13tindi2b4xmZlLd_NKAX75EY9mIQ--" initial={{x:300}} whileInView = {{x:0}} transition={{duration:"2"}} />
          ...
          <div className="person person-2">
            ...
            <div className="right-side">
              <motion.img initial={{x:-300}} whileInView = {{x:0}} transition={{duration:"2"}}  src="https://ice-eu-108964.icedrive.io/download?p=HsE.Avkgho139bzq5c6mYOu3jX21mTSgptDX2GVoQc1ab.xyl2CdpRNk_gbY2PWwGUx7sKuXuBvnN0o3.i0uLUrjRLoJG.Iccg8Bw1mvE0pBGp00RjzZCopg9IdEur3tKnTCbZ09QdnYn2e7iWaZ0Q1pEHBZrREzdqY1Wzxapbzm9pfTzXqRRKmtc13tindi2b4xmZlLd_NKAX75EY9mIQ--" />
              <div className="frame frame-1"></div>
            </div>
          </div>
